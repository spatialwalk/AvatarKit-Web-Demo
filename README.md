...
- **SDK package** `@spatialwalk/avatarkit@^1.0.0-beta.25` or later (automatically installed with `npm install`)
...
- **SDK Version**: `@spatialwalk/avatarkit@^1.0.0-beta.25`
...
A: Install via npm (SDK version 1.0.0-beta.25 or later):
```bash
npm install @spatialwalk/avatarkit@^1.0.0-beta.25
```
